...
if %3 == Full (Set where=test=~Tests) ELSE (Set where=test=~ShowAssemblyTargets)
nunit3-console-%2.exe --noheader --workers=1 --where "test=~GenericTest" --work=bin\Release\%1 bin\Release\%1\Universe.NUnitPipeline.Tests.dll
